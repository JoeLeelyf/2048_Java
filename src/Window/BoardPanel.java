...
public class BoardPanel extends JPanel implements KeyListener {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (isValidInput && !GameOver() && !Win() && !endGame) {
    ...
    public void initGame(int[][] boardExisted, int scoreExisted) {
        controller.SetBoard(boardExisted, scoreExisted, scoreExisted);
        score = scoreExisted;
        bestScore = scoreExisted;
        isValidInput = false;
        addKeyListener(this);
        repaint();
    }
